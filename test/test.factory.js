...
tape( 'the function throws an error if provided an invalid third distribution parameter', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided an invalid third distribution parameter (options)', function test( t ) {
	var values;
	var i;
...
tape( 'when called without distribution parameters, the function returns a function which generates `NaN` values if the third distribution parameter is `NaN`', function test( t ) {
	var random;
	var actual;
	var i;

	random = factory();
	actual = random( 10, 2.0, 5.0, NaN );
...
tape( 'the function supports providing a seeded underlying PRNG (parameters)', function test( t ) {
	...
	arr1 = random1( 10, 2.0, 5.0, 3.0 );
	arr2 = random2( 10, 2.0, 5.0, 3.0 );
	t.deepEqual( arr1, arr2, 'returns expected value' );
